...
gulp.task('cp:pl', function () {
  return gulp.src('node_modules/patternlab-node/core/**')
    ...
    .on('end', function () {
      ...
      var header = '<div class="a-sg-header-top"><a href="http://prosjekt.olavstoppen.no/projects/altinn/" target="_blank" class="a-sg-header-title">Pattern Lab</a><div class="a-sg-header-links"><a href="https://github.com/Altinn/DesignSystem">Åpne i Github </a><a href="#">Om designsystemet</a></div></div>'
