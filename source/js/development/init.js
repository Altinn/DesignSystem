...
window.smoothStateMod = function() {
  $('#smoothState').find('a:not(.a-collapseTitle):not(.a-collapseBtn):not(.sr-only-focusable):not(.a-colnav-item):not(.a-colnav-item-second):not(.a-colnav-item-third)').on('click', function(e) {
