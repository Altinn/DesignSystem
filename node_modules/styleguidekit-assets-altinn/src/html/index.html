...
<html id="patternlab-html">
  <head id="patternlab-head">
    ...
    <!-- <link rel="stylesheet" href="styleguide/css/styleguide-edit.css" media="all" /> -->
  ...
  <body id="patternlab-body">
    ...
    <header class="sg-header" role="banner">
      <div class="a-sg-header-top">
        <a href="http://altinn.github.io/DesignSystem/" title="Åpne i eget vindu" target="_blank" class="a-sg-header-title">Pattern Lab <svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg" style="vertical-align: bottom;
    width: 18px;
    margin-top: -8px;">
        ...
        <div class="a-sg-header-links">
          <a href="http://altinn-dev.dev.bouvet.no/en/profil/">Tilbake til profilmanual</a>
    ...
    <script type="text/mustache" id="pl-ish-controls-template">
      @@include('./partials/ish-controls.html')
    </script>
