...
function changeCss(project) {
  ...
  case 'altinn':
    ...
    $viewPortContents.find('head link[href~=\'../../css/style.dist.altinn.css\']').prop('disabled', false);
    break;
  case 'altinnett':
    $viewPortContents.find('head link[href~=\'../../css/style.dist.brreg.css\']').prop('disabled', true);
    $viewPortContents.find('head link[href~=\'../../css/style.dist.altinnett.css\']').prop('disabled', false);
    $viewPortContents.find('head link[href~=\'../../css/style.dist.altinn.css\']').prop('disabled', true);
    break;
  case 'brreg':
